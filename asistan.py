...
st.markdown("""
    ...
    div[data-testid="stColumn"] {
        flex: 1 !important;
        min-width: 23% !important; /* 4 tane sığması için */
    }
    ...
    div.stButton > button {
        ...
        width: 100% !important;
        height: 110px !important; /* 4'lü yapıda yükseklik biraz azaldı */
    ...
    div.stButton > button p {
        ...
        font-size: 14px !important; /* 4 tane yan yana olduğu için fontu biraz küçülttük */
